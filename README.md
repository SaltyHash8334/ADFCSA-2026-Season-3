# ADF CSA 2026 Season 3 — Writeups

Writeups for the ADF CSA 2026 Season 3 CTF challenges by SaltyHash443.
...
| 6 | [BlindfoldJourney](writeups/blindfoldjourney.md) | Geo-Intelligence | `FLAG{THESUS}` |
| 7 | [CryptoBabble](writeups/cryptobabble.md) | Cryptanalysis | `FLAG{CUREIS}` |

## Structure

```
writeups/       # Writeup markdown files
